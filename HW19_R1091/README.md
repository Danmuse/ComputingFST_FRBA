...
## __RETURN VALUE__
        ...
        On success, _*fread()*_ and _*fwrite()*_ return the number of items read or
...
The **_fseek()_** function sets the file position indicator for the stream pointed to by stream.
...
The _ftell()_ function obtains the current value of the file position indicator for the stream pointed to by stream.
