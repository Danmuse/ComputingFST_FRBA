...
/**
 * \fn int connect(int argc, char *argv[])  
...
int connecting(int argc, char *argv[]) {
	int sockfd;
...
/*
 * \fn int openConection(struct sockaddr_in * my_addr)  
...
int openConnection(struct sockaddr_in * my_addr) {
	int sockaux;
	int aux;
